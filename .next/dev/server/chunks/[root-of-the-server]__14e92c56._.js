...
"[project]/src/server/data/exercises.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/server/data/yoga.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/server/constants.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$data$2f$exercises$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/data/exercises.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$data$2f$yoga$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/data/yoga.ts [app-route] (ecmascript)");
;
;
;
const ALL_DATASETS = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$data$2f$exercises$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISES"],
    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$data$2f$yoga$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["YOGA"]
];
}),
...
"[project]/src/app/api/generate-workout/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/server/constants.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$data$2f$yoga$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/data/yoga.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$data$2f$exercises$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/data/exercises.ts [app-route] (ecmascript)");
...
async function POST(req) {
    try {
        ...
        let availableExercises = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ALL_DATASETS"];
        if (userData.trainingPreference === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TrainingPreference"].YOGA) {
            availableExercises = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$data$2f$yoga$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["YOGA"];
        } else if (userData.trainingPreference === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TrainingPreference"].GYM) {
            availableExercises = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$data$2f$exercises$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISES"];
        }
    ...
    `;
        ...
        rawJson.days.forEach((day)=>{
            day.exercises = day.exercises.map((ex)=>{
                const found = availableExercises.find((d)=>d.name.toLowerCase() === ex.name.toLowerCase() || ex.name.toLowerCase().includes(d.name.toLowerCase()));
                if (found) {
                    return {
                        ...ex,
                        name: found.name,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(rawJson);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14e92c56._.js.map